...
public class Zondbe
{
    public ZondbeCharasteristics Charasteristics;
    public ZondbeSkull Skull;
    public WalkingStrategy WalkingStrategy;
    
    public Zondbe(ZondbeFabric zondbeFabric)
    {
        Charasteristics = zondbeFabric.CreateZondbe();
        Skull = zondbeFabric.CreateSkull();
        WalkingStrategy = zondbeFabric.CreateWalkingStrategy();
    }
}